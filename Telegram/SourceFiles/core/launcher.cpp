...
void Launcher::init() {
	...
	QApplication::setApplicationName(qsl("Bettergram"));
	QApplication::setOrganizationName(qsl("Bettergram LLC"));
	QApplication::setOrganizationDomain(qsl("bettergram.io"));
...
int Launcher::exec() {
	...
	if (!UpdaterDisabled() && cRestartingUpdate()) {
		...
		DEBUG_LOG(("Sandbox Info: executing Bettergram, because of restart."));
